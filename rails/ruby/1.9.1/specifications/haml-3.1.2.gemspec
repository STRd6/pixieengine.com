...
Gem::Specification.new do |s|
  ...
  s.files = ["test/haml/engine_test.rb", "test/haml/html2haml_test.rb", "test/haml/template_test.rb", "test/haml/util_test.rb", "test/haml/helper_test.rb", "test/haml/spec_test.rb", "test/haml/spec/ruby_haml_test.rb", "bin/haml", "bin/html2haml"]
