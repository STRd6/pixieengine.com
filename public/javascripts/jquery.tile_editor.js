/* DO NOT MODIFY. This file was compiled Wed, 27 Apr 2011 05:38:50 GMT from
...
(function() {
  $.fn.tileEditor = function(options) {
    ...
    return this.each(function() {
      var addNewLayer, addScreenLayer, clearSelection, clickMode, currentLayer, currentTool, debugMode, entered, firstGID, floodFill, getNeighborPositions, harvestSelection, hotkeys, inBounds, isInSelection, layerSelect, loadData, modeDown, nextTile, parentId, positionElementIndices, prevTile, propEditor, propElement, removeTile, replaceTile, saveData, savedSelectionCount, select, selectNextVisibleLayer, selectTile, selectTool, selectionCache, selectionCopy, selectionCut, selectionDelete, selectionEach, selectionStart, stamp, tileAt, tileEditor, tileHeight, tilePosition, tileTray, tileWidth, tilesTall, tilesWide;
      ...
      tileEditor.find("button.save").click(function() {
        ...
        callback = function(data) {
          var id;
          id = data.tilemap.id;
          return notify("Saved as <a href='/tilemaps/" + id + "'>Tilemap " + id + "</a>!");
        };
        return $.post('/tilemaps', postData, callback, "json");
      });
      saveData = function() {
      ...
      return tileEditor.find(".screen .layers").css({
        width: tilesWide * tileWidth,
        height: tilesTall * tileHeight
      });
    });
